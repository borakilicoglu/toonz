...
test "official fixtures subset" {
    ...
    try runEncodeFixtureFile(
        ...
        &.{
            ...
            "encodes safe string with underscore and numbers",
            "quotes empty string",
            "quotes string that looks like true",
            "quotes string that looks like false",
            "quotes string that looks like null",
            "quotes string that looks like integer",
            "quotes string that looks like negative decimal",
            "quotes string that looks like scientific notation",
            "quotes string with leading zero",
            "escapes newline in string",
            "escapes tab in string",
            "escapes carriage return in string",
            "escapes backslash in string",
            "quotes string with array-like syntax",
            "quotes string starting with hyphen-space",
            "quotes single hyphen as object value",
            "quotes string starting with hyphen as object value",
            "quotes single hyphen in array",
            "quotes leading-hyphen string in array",
            "quotes string with bracket notation",
            "quotes string with brace notation",
            "encodes Unicode string without quotes",
            "encodes Chinese characters without quotes",
            "encodes emoji without quotes",
            "encodes string with emoji and spaces",
            "encodes positive integer",
            "encodes decimal number",
            "encodes negative integer",
            "encodes zero",
            "encodes negative zero as zero",
            "encodes scientific notation as decimal",
            "encodes small decimal from scientific notation",
    ...
    try runEncodeFixtureFile(
        ...
        &.{
            ...
            "encodes empty string keys for empty arrays",
            "encodes empty string in single-item array",
            "encodes empty string in multi-item array",
            "encodes whitespace-only strings in arrays",
            "quotes array strings with comma",
            "quotes strings that look like booleans in arrays",
            "quotes strings with structural meanings in arrays",
        },
    );
    ...
    try runEncodeFixtureFile(
        ...
        &.{
            ...
            "quotes string value with embedded quotes",
            "quotes string value with leading space",
            "quotes string value with only spaces",
            "quotes string value that looks like true",
            "quotes string value that looks like number",
            "quotes string value that looks like negative decimal",
    ...
    try runDecodeFixtureFile(
        ...
        &.{
            ...
            "parses unquoted string with underscore and numbers",
            "parses empty quoted string",
            "parses quoted string with newline escape",
            "parses quoted string with tab escape",
            "parses quoted string with carriage return escape",
            "parses quoted string with backslash escape",
            "parses quoted string with escaped quotes",
            "parses Unicode string",
            "parses Chinese characters",
            "parses emoji",
            "parses string with emoji and spaces",
            ...
            "respects ambiguity quoting for false",
            "respects ambiguity quoting for null",
            "respects ambiguity quoting for integer",
            "respects ambiguity quoting for negative decimal",
            "respects ambiguity quoting for scientific notation",
            "respects ambiguity quoting for leading-zero",
        },
    );
    ...
    try runDecodeFixtureFile(
        ...
        &.{
            ...
            "parses nested arrays with tab delimiter",
            "parses nested arrays with pipe delimiter",
            ...
            "parses nested array values containing pipe delimiter",
            "parses nested array values containing tab delimiter",
            "preserves quoted ambiguity with pipe delimiter",
            "preserves quoted ambiguity with tab delimiter",
            "parses structural-looking strings when quoted with pipe delimiter",
            "parses structural-looking strings when quoted with tab delimiter",
            "parses tabular headers with keys containing the active delimiter",
        },
    );
    ...
    try runDecodeFixtureFile(
        ...
        &.{
            ...
            "throws on mismatched delimiter between bracket and brace fields",
        },
    );
    ...
    try runDecodeFixtureFile(
        ...
        &.{
            ...
            "accepts deeply nested non-multiples when strict=false",
    ...
    try runDecodeFixtureFile(
        ...
        &.{
            ...
            "parses quoted object value with only spaces",
            "parses quoted string value that looks like true",
            "parses quoted string value that looks like integer",
            "parses quoted string value that looks like negative decimal",
            ...
            "parses quoted key with braces",
            "parses quoted key with comma",
            "parses quoted key with spaces",
            "parses quoted key with leading hyphen",
            "parses quoted key with leading and trailing spaces",
            "parses quoted numeric key",
            "parses quoted empty string key",
            "parses dotted keys as identifiers",
            "parses underscore-prefixed keys",
            "parses underscore-containing keys",
            "unescapes newline in key",
            "unescapes tab in key",
            "unescapes quotes in key",
